...
This weekend I finished the basic setup of my new homelab! 
Using the 4 C6100 nodes I made a 3-way hyper-redundant Ceph cluster. This means of my 24TB Raw storage I now have 8TB of hyper-redundant storage. 
All drives are SATA-III for fastest speeds possible. 
If 1 of the drives fail the data is safe, if a node fails the data is fine and even if 2 nodes fail then the data is still there and when I swap any dead drives it will build itself back together. 
There are also a few new mappings for some systems on my network:
...
pve1 and pve2 are the main nodes for controlling the ceph cluster and the overall proxmox cluster. 
With a cluster I have a near limitless amount of computational power for my needs, this is the hardware specifications for each node:
