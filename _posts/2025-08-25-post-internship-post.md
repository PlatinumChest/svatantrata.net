...
- VLANs: We saw the network diagram for campus along with what each VLAN was tied to and their purposes.
- Cabling: I terminated and tested various cables including some ports to identify port configurations and status using Fluke Network devices.
- Documentation: I had to document all the ports in a room to see if they are in the right configuration as well as if any of them did not receive signal or were broken, I also had to keep track of all the devices we were provisioning and ensure everything was correct.
